...
*/
:- module(tdaTrain_212788287_EspinozaBarria,[train/6,isTrain/1,getIdTrain/2,getMakerTrain/2,getRailTypeTrain/2,getSpeedTrain/2,getPCARsTrain/2,trainAddCar/4,trainRemoveCar/3,trainCapacity/2]).
